...
-|------|---|---|--
2|Bruker 1D <sup>1</sup>H NMR spectrum|requireFileNamed(`1r`) & requireFileNamed(`../../fid`) & requireFileNamed(`../../acqus`) & requireFileInclude(") in "`../../acqus`"|x/y plot (ppm/intensity)|[JCAMP-DX](http://jcamp-dx.org/), simple x/y plot
